...
export const CONFIG: Config = {
  ...
  contact: {
    ...
    address:
      "Plot # LR-1/3, Old Haji Camp, Siddique Wahab Road Timber Market, Karachi",
  },
  socialLinks: {
  ...
  productRange: [
    {
      title: "Burma Teak",
      description:
        "Premium quality teak for high-end furniture and construction.",
      icon: "TreeDeciduous",
    },
    {
      title: "Softwood",
      description:
        "Versatile softwood solutions for various industrial applications.",
      icon: "Zap",
    },
    {
      title: "Hardwood",
      description: "Durable and strong hardwood for heavy-duty structural use.",
      icon: "Hammer",
    },
    {
      title: "Plywood",
      description:
        "High-grade plywood for versatile interior and exterior needs.",
      icon: "Layers",
    },
    {
      title: "MDF & Boards",
      description: "Engineered wood products for modern cabinetry and design.",
      icon: "Box",
    },
    {
      title: "Laminates",
      description:
        "High-pressure laminates for aesthetic and durable surfaces.",
      icon: "Shield",
    },
  ],
  testimonials: [
    {
      ...
      content:
        "MK Enterprises has been our go-to supplier for decades. Their Burma Teak quality is unmatched in the Karachi market.",
      date: "Oct 12, 2025",
    },
    {
      name: "Sajid Mehmood",
      ...
      content:
        "The consistency in their softwood imports has helped our production line tremendously. Highly recommended for industrial needs.",
      date: "Nov 05, 2025",
    },
    {
      name: "Zeeshan Khan",
      ...
      content:
        "Excellent variety of laminates and boards. The team is professional and delivery is always on time.",
      date: "Dec 20, 2025",
    },
    {
      name: "Imran Siddiqui",
      role: "Architect",
      content:
        "Reliable quality and honest dealings. They understand the technical requirements of large-scale projects.",
      date: "Jan 15, 2026",
    },
  ],
  lumberProducts: [
    {
      name: "Ash",
      image: "/products/ash.webp",
      description:
        "Non-resistant to heartwood decay. Ideal for architectural interiors.",
    },
    {
      name: "Beech",
      image: "/products/beech.webp",
      description:
        "Classed as heavy, hard, strong, high in resistance to shock and highly suitable for steam bending.",
    },
    {
      name: "Burma Teak",
      image: "/products/burma-teak.webp",
      description:
        "Holds paint and stain very well and can be polished to an exceptional finish.",
    },
    {
      name: "Cherry",
      image: "/products/cherry.webp",
      description: "The wood is hard and heavy with good strength properties.",
    },
    {
      name: "Dark Red Meranti",
      image: "/products/dark-red-meranti.webp",
      description: "Most reliable wood for flooring and doors.",
    },
    {
      name: "Hard Maple",
      image: "/products/hard-maple.webp",
      description: "The wood is hard and heavy with good strength properties.",
    },
    {
      name: "Mahagony",
      image: "/products/mahagony.webp",
      description:
        "Much sought-after wood based on its hardness, resilience and beauty.",
    },
    {
      name: "Red Oak",
      image: "/products/red-oak.webp",
      description:
        "The wood is hard and heavy, with medium bending strength and stiffness.",
    },
    {
      name: "Soft Maple",
      image: "/products/soft-maple.webp",
      description:
        "Soft maple can be stained and polished to an excellent finish.",
    },
    {
      name: "Softwood",
      image: "/products/soft-wood.webp",
      description:
        "A versatile timber used in furniture, interior joinery, kitchen cabinets, etc.",
    },
    {
      name: "Walnut",
      image: "/products/walnut.webp",
      description:
        "Rated as very resistant to heartwood decay. Can be used for furniture, cabinets and architectural interiors.",
    },
    {
      name: "Wenge",
      image: "/products/wenge.webp",
      description: "Most reliable wood for flooring and doors.",
    },
    {
      name: "Yellow Meranti",
      image: "/products/yellow-meranti.webp",
      description: "Most reliable wood for flooring and doors.",
    },
  ],
  engineeredProducts: [
    {
      ...
      description:
        "Perfectly shaped to appear like wood products but are more efficient and versatile in terms of design and finishing.",
    },
    {
      name: "Wood Plastic Composite (WPC)",
      image: "/products/wood-plastic-composite.webp",
      description:
        "Versatile wood and plastic product is the ultimate choice for exterior applications.",
    },
    {
      name: "PVC Wall Panel",
      image: "/products/pvc-wall-panel.webp",
      description:
        "An affordable yet attractive alternative to tiles. Waterproof and ideal for kitchens and dining rooms.",
    },
    {
      name: "Soft Board",
      image: "/products/soft-board.webp",
      description:
        "A low density wood panel fiberboard. Lightweight and easily manageable.",
    },
    {
      name: "UV MDF",
      image: "/products/uv-mdf.webp",
      description:
        "UV MDF has the beauty and strength to fulfill your decorative needs through polished wood.",
    },
    {
      name: "Medium Density Fiberboard",
      image: "/products/mdf.webp",
      description:
        "A wood-panel product reconstituted from wood fibers, therefore smoothly dense.",
    },
    {
      name: "Plywood",
      image: "/products/plywood.webp",
      description:
        "Most reliable and versatile engineered wood, exclusively tailored to meet all your needs.",
    },
  ],
  productDetails: {
    ash: {
      ...
      properties: {
        ...
        physical:
          "Ash has very some good overall strength properties relative to its weight. It has excellent shock resistance and is good for steam bending.",
        durability:
          "Non resistant to heart wood decay. The sapwood is liable to attack by powder post and the common furniture beetle. The heartwood is moderately resistant to preservative treatment, and the sapwood is permeable.",
      ...
      specs: [
        ...
        {
          label: "SPECIFIC VOLUMETRIC SHRINKAGE",
          sublabel: "(GREEN TO 6% M.C)",
          value: "10.7",
          unit: "%",
        },
    ...
    beech: {
      ...
      properties: {
        working:
          "Beech works readily with most hand & machine tools. It has good nailing & gluing properties and can be stained & polished to a good finish. The wood dries fairly rapidly but with a strong tendency to warp, split & surface check. It is subject to a large shrinkage and moderate movement in performance.",
        physical:
        ...
        uses: "Furniture, Flooring, doors, internal joinery, panelling, brush handles and turning. It is particularly suitable for food containers as there is no odour or taste. and moulding, kitchen cabinets, panelling, tool handles, sports goods and turning",
      },
      ratings: [
      ...
      specs: [
        ...
        { label: "MODULES OF ELASTICITY", value: "11,859" },
        { label: "HARDNESS", value: "5872" },
      ],
    },
    "burma-teak": {
      name: "Burma Teak",
      ...
      specs: [
        ...
        { label: "MODULES OF ELASTICITY", value: "11,58" },
        { label: "HARDNESS", value: "4" },
      ],
    },
    cherry: {
      name: "Cherry",
      ...
      properties: {
        working:
          "Cherry is easy to machine, nails and glues well and when sanded, stained and polished, it produces an excellent smooth finish, it dries fairly quickly with moderately large shrinkage, but is dimentionally stable after kilning.",
        physical:
      ...
      specs: [
        ...
        { label: "MODULES OF ELASTICITY", value: "10,274" },
        { label: "HARDNESS", value: "4226" },
      ],
    },
    "dark-red-meranti": {
      name: "Dark Red Meranti",
      ...
      properties: {
        working:
          "Dark Red Meranti comes in various colors such as pale pink, white to dark red, and purple. There are various sub species of the Red Meranti wood and the density of them all varies significantly. It is easy to machine and is often used as false 'mahogany' for various products.",
        physical:
          "Dark Red Meranti is typically of a dark reddish or a purple brown and features white resin streaks. The wood comes in straight and interlocked grain with a coarse texture and little natural luster.",
        durability:
          "Rated as moderately durable to non-durable in decay resistance and is vulnerable to insect attacks.",
      ...
      specs: [
        ...
        { label: "MODULES OF ELASTICITY", value: "13,020" },
        { label: "HARDNESS", value: "3,570" },
      ],
    },
    "hard-maple": {
      name: "Hard Maple",
      ...
      specs: [
        ...
        { label: "MODULES OF ELASTICITY", value: "12,618" },
        { label: "HARDNESS", value: "6450" },
      ],
    },
    mahagony: {
      name: "Mahagony",
      ...
      specs: [
        ...
        { label: "MODULES OF ELASTICITY", value: "11,584" },
        { label: "HARDNESS", value: "4492" },
      ],
    },
    "red-oak": {
      name: "Red Oak",
    ...
    "soft-maple": {
      ...
      specs: [
        ...
        { label: "MODULES OF ELASTICITY", value: "11,308" },
        { label: "HARDNESS", value: "4226" },
      ],
    },
    softwood: {
      ...
      specs: [
        ...
        { label: "MODULES OF ELASTICITY", value: "10,894" },
        { label: "HARDNESS", value: "2402" },
      ],
      regionalSpecs: [
        {
          region: "USA",
    ...
    wenge: {
      ...
      specs: [
        ...
        { label: "MODULES OF ELASTICITY", value: "21,050" },
        { label: "HARDNESS", value: "8,600" },
      ],
    },
    "yellow-meranti": {
      name: "Yellow Meranti",
      ...
      properties: {
        working:
          "The Yellow meranti is one of the most common tropical hardwoods. It is easy to handle with machine tools and is tough to handle with hand tools because of its hardness and high density. It absorbs pain quickly and glues well but it is advised to use oil for paints and heavy duty glue due to the high density of the hardwood.",
        physical:
          "The Yellow Meranti is a typically yellow and yellow to brown color that will darken with age. The wood had a coarse texture and large pores with interlocked grain.",
        durability:
          "Rated as non-durable in decay resistance and is vulnerable to insect attacks.",
      ...
      specs: [
        ...
        { label: "MODULES OF ELASTICITY", value: "14,100" },
        { label: "HARDNESS", value: "3,120" },
      ],
    },
    plywood: {
      name: "Plywood",
      ...
      subProducts: [
        {
          ...
          description:
            "Available in wide range of wood veneers like: red oak, maple, sapele, beech, walnut, ebony, wenge, Burma teak, white ash, ash and many more. This aesthetically pleasing hardwood veneer with top notch quality especially designed to meet your wood based decorative needs.",
        ...
        },
        {
          ...
          dimensions:
            "Dimensions: 5mm x 4ft x 8ft, 11mm x 4ft x 8ft, 18mm x 4ft x 8ft",
        },
      ],
    },
    ...
    "wood-plastic-composite-wpc": {
      ...
      subProducts: [
        ...
        },
        {
          ...
          description:
            "Our finest quality WPC for decking is a reliable solution to your decking needs. Durable, water resistant, ecofriendly and to top it all, does not require paint, stain or seal. The WPC decking is wear-resistant with qualities like: not attracting mold due to its inability to store water or rot. The colors stay as good as new without splitting or rotting. The wood counterpart in terms of appearance and handling but is as durable as plastic.",
        ...
        },
        {
          ...
          description:
            "Now you can add the panache of wood and the durability of plastic to your wood panels with the ease to install and low maintenance WPC wall panels. Available in a range of colors, patterns and widths for you to add a unique touch to your walls. Environment Friendly, fire, UV rays, impact and water resistant, these WPC wall panels also rid you from the complexities of paint, wrapping or uneven finishing.",
    ...
    "door-skin": {
      ...
      subProducts: [
        ...
        },
        {
          ...
          applications: [
            "Interior and exterior door skins",
            "Partition skins",
            "Door paneling",
          ],
          description:
            "Melamine door skins are perfectly shaped to appear like wood products but are more efficient and versatile in terms of design and finishing. They provide a high-resistance surface that is easy to clean and maintain while offering a premium look for commercial and residential door projects.",
