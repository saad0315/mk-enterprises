export const CONFIG = {
  ...
  lumberProducts: [
    { name: "Wenge", description: "Most reliable wood for flooring and doors." },
    { name: "Yellow Meranti", description: "Most reliable wood for flooring and doors." },
    { name: "Dark Red Meranti", description: "Most reliable wood for flooring and doors." },
    { name: "Walnut", description: "Rated as very resistant to heartwood decay. Can be used for furniture, cabinets and architectural interiors." },
    { name: "Softwood", description: "A versatile timber used in furniture, interior joinery, kitchen cabinets, etc." },
    { name: "Soft Maple", description: "Soft maple can be stained and polished to an excellent finish." },
    { name: "Red Oak", description: "The wood is hard and heavy, with medium bending strength and stiffness." },
    { name: "Mahagony", description: "Much sought-after wood based on its hardness, resilience and beauty." },
    { name: "Hard Maple", description: "The wood is hard and heavy with good strength properties." },
    { name: "Cherry", description: "The wood is hard and heavy with good strength properties." },
    { name: "Beech", description: "Classed as heavy, hard, strong, high in resistance to shock and highly suitable for steam bending." },
    { name: "Ash", description: "Non-resistant to heartwood decay. Ideal for architectural interiors." },
    { name: "Burma Teak", description: "Holds paint and stain very well and can be polished to an exceptional finish." },
  ],
  engineeredProducts: [
    { name: "Door Skin", description: "Perfectly shaped to appear like wood products but are more efficient and versatile in terms of design and finishing." },
    { name: "Wood Plastic Composite (WPC)", description: "Versatile wood and plastic product is the ultimate choice for exterior applications." },
    { name: "PVC Wall Panel", description: "An affordable yet attractive alternative to tiles. Waterproof and ideal for kitchens and dining rooms." },
    { name: "Soft Board", description: "A low density wood panel fiberboard. Lightweight and easily manageable." },
    { name: "UV MDF", description: "UV MDF has the beauty and strength to fulfill your decorative needs through polished wood." },
    { name: "MDF", description: "A wood-panel product reconstituted from wood fibers, therefore smoothly dense." },
    { name: "Plywood", description: "Most reliable and versatile engineered wood, exclusively tailored to meet all your needs." },
  ],
  productDetails: {
    "burma-teak": {
      name: "Burma Teak",
      ...
      subProducts: [
        {
          ...
          image: "/hero-timber.jpg", // Using placeholder, update if specific MDF image exists
